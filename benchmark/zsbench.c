...
static char *create_tmp_dir_name(void)
{
       static const char letters[] =
        ...
        for (count = 0; count < TMP_MAX; ++count) {
                ...
                dirname_template[0] = letters[v % num_letters]; v /= num_letters;
                dirname_template[1] = letters[v % num_letters]; v /= num_letters;
                dirname_template[2] = letters[v % num_letters]; v /= num_letters;
                dirname_template[3] = letters[v % num_letters]; v /= num_letters;
                dirname_template[4] = letters[v % num_letters]; v /= num_letters;
                dirname_template[5] = letters[v % num_letters]; v /= num_letters;
...
static int run_benchmarks(void)
{
        ...
        for (i = 0; i < benchmarks.count; i++) {
                if (strcmp(benchmarks.datav[i], "writeseq") == 0) {
                        ...
                        fprintf(stderr, "writeseq: %zu bytes written in %" PRIu64 " micro-seconds.\n",
                                bytes, (finish - start));
